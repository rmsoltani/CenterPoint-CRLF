...
db_sampler = dict(
    type="GT-AUG",
    enable=False,
    db_info_path="data/nuScenes/v1.0-mini/dbinfos_train_10sweeps_withvelo.pkl",
    sample_groups=[
        dict(car=2),
        dict(truck=3),
...
train_anno = "data/nuScenes/v1.0-mini/infos_train_10sweeps_withvelo_filter_True.pkl"
val_anno = "data/nuScenes/v1.0-mini/infos_val_10sweeps_withvelo_filter_True.pkl"
test_anno = None
